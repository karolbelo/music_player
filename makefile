...
music_player: objects/main.o objects/music.o objects/node.o objects/linked_list.o objects/playlist.o objects/playlist_node.o objects/playlists.o
		g++ objects/*.o -Iheaders -Wall -ansi -pedantic -std=c++11 -g -o music_player
...
objects/music.o: src/music.cpp
		g++ src/music.cpp -Iheaders -Wall -ansi -pedantic -std=c++11 -g -c -o objects/music.o

objects/node.o: src/node.cpp objects/music.o
		g++ src/node.cpp -Iheaders -Wall -ansi -pedantic -std=c++11 -g -c -o objects/node.o objects/music.o

objects/linked_list.o: src/linked_list.cpp objects/music.o objects/node.o
		g++ src/linked_list.cpp -Iheaders -Wall -ansi -pedantic -std=c++11 -g -c -o objects/linked_list.o

objects/playlist.o: src/playlist.cpp objects/linked_list.o
		g++ src/playlist.cpp -Iheaders -Wall -ansi -pedantic -std=c++11 -g -c -o objects/playlist.o

objects/playlist_node.o: src/playlist_node.cpp objects/playlist.o
		g++ src/playlist_node.cpp -Iheaders -Wall -ansi -pedantic -std=c++11 -g -c -o objects/playlist_node.o
